...
#DEBUG_TOOLBAR_CONFIG = {'INTERCEPT-REDIIRECTS':False,}
DATABASES = {
  'default':
...
MEDIA_ROOTNEW = os.path.join(os.path.dirname(__file__), '..static/media')
#MEDIA_ROOT = '/static'
...
FILE_URL1 =os.path.join(os.path.dirname(__file__), '../gstudio/static/gstudio/json/tag_cloud.json')
#FILE_URL2 =os.path.join(os.path.dirname(__file__), '../gstudio/static/gstudio/json/tag_cloud_url.json')
